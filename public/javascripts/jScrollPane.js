	...
	return this.each(
		function()
		{
			...
			if (jQuery(this).parent().is('.jScrollPaneContainer')) {
				...
				jQuery('>.jScrollPaneTrack, >.jScrollArrowUp, >.jScrollArrowDown, >.jScrollCap', $c).remove();
				$this.css({'top':0});
			} else {
			...
			if (settings.reinitialiseOnImageLoad) {
				...
				var $imagesToLoad = $.data(paneEle, 'jScrollPaneImagesToLoad') || jQuery('img', $this);
				var loadedImages = [];
			...
			if (isScrollable) {
				...
				var onStartDrag = function(event)
				{
					...
					jQuery('html').bind('mouseup', onStopDrag).bind('mousemove', updateScroll).bind('mouseleave', onStopDrag)
					if ($.browser.msie) {
